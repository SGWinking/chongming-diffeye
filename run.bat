@echo off
rem ===========================================================================
rem  Dayun Mural Toolkit - Chongming DiffEye (image structure comparison) - entry
rem
...
rem
rem  Verify with:  fix-ps1-encoding.ps1 -Path .\run.ps1,.\run.bat -Check
rem ===========================================================================

chcp 65001 >nul
title Dayun Mural Toolkit - Chongming DiffEye
